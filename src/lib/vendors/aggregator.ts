...
// Re-export health query functions (kept in vendor-health.ts to avoid pulling
// the registry → base-fetcher → env import chain into the admin API bundle).
export { detectDuplicateVendors, getVendorHealthReport } from "./vendor-health";
