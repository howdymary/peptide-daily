...
async function getHomepageData() {
    try {
          const [featuredNews, editorsPicks, guides, peptides, recentPrices] =
                  await Promise.all([
  ...
  return (
        <div>
              ...
              <section
                ...
                {/* Subtle diagonal stripe texture */}
                      ...
                      <div className="container-page relative">
                                <div className="mx-auto max-w-2xl">
                                  ...
                                  {/* Headline */}
                                            ...
                                            <p
                                                          ...
                                                          >
                                                          Whether you&apos;re researching peptides for weight loss, skin
                        ...
                        { href: "/vendors", label: "See vendor ratings" },
          ...
          },
          {
                            number: "03",
                            title: "Trust Score",
                            body: "Our Trust Score (0–100) weights three factors: Finnrick lab quality (50%), community review sentiment (30%), and pricing relative to the category median (20%). The breakdown is always visible — nothing is hidden behind the number.",
